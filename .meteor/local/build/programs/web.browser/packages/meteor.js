...
if (document.addEventListener) {                                                                            // 11
  ...
  window.attachEvent('load', ready);                                                                        // 19
                                                                                                            ...
                                                                                                            // 21
/**                                                                                                         // 22
 * @summary Run code when a client or a server starts.                                                      // 23
 * @locus Anywhere                                                                                          // 24
 * @param {Function} func A function to run on startup.                                                     // 25
 */                                                                                                         // 26
Meteor.startup = function (cb) {                                                                            // 27
  var doScroll = !document.addEventListener &&                                                              // 28
    document.documentElement.doScroll;                                                                      // 29
                                                                                                            // 30
  if (!doScroll || window !== top) {                                                                        // 31
    if (loaded)                                                                                             // 32
      cb();                                                                                                 // 33
    else                                                                                                    // 34
      queue.push(cb);                                                                                       // 35
  } else {                                                                                                  // 36
    try { doScroll('left'); }                                                                               // 37
    catch (e) {                                                                                             // 38
      setTimeout(function() { Meteor.startup(cb); }, 50);                                                   // 39
      return;                                                                                               // 40
    };                                                                                                      // 41
    cb();                                                                                                   // 42
  }                                                                                                         // 43
...
//# sourceMappingURL=ba96dc1f04ac6e63264a9aea0915717a5e52c365.map
