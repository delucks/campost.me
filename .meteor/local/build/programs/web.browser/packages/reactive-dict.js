...
_.extend(ReactiveDict.prototype, {                                                      // 22
  ...
  equals: function (key, value) {                                                       // 62
    ...
    var ObjectID = Mongo.Collection && Mongo.ObjectID;                                  // 66
                                                                                        // 67
  ...
  _ensureKey: function (key) {                                                          // 109
    ...
    if (!(key in self.keyDeps)) {                                                       // 111
      self.keyDeps[key] = new Tracker.Dependency;                                       // 112
...
//# sourceMappingURL=63897b8c00d8af11f361acebee477317a52ff64f.map
